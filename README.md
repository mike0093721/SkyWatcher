...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Roboto', sans-serif; background-color: #121212; color: #ffffff; line-height: 1.6; }
        a { color: #00bcd4; text-decoration: none; }
        a:hover { color: #0097a7; }
        header { background-color: #1f1f1f; padding: 20px 0; text-align: center; }
        header img { width: 150px; }
        header h1 { font-family: 'Orbitron', sans-serif; margin-top: 10px; font-size: 2em; color: #00bcd4; }
        nav { background-color: #333; display: flex; justify-content: center; flex-wrap: wrap; }
        nav a { padding: 15px 20px; color: #ffffff; transition: background-color 0.3s ease; }
        nav a:hover { background-color: #575757; }
        .container { padding: 40px 20px; max-width: 1200px; margin: 0 auto; }
        section h2 { font-family: 'Orbitron', sans-serif; font-size: 1.8em; margin-bottom: 20px; color: #00bcd4; border-bottom: 2px solid #00bcd4; display: inline-block; padding-bottom: 5px; }
        section p, ul { font-size: 1.1em; color: #cccccc; }
        #basico-opciones, #plus, #premium, #opcion1, #opcion2 { display: none; }
        .paquetes-opciones, .paquetes-niveles { background-color: #1f1f1f; padding: 10px 20px; border-radius: 5px; margin-bottom: 20px; cursor: pointer; }
        .paquetes-opciones:hover { background-color: #333; }
        .paquetes-niveles:hover { background-color: #222; }

        /* Contacto */
        .contact-info p { margin-bottom: 10px; font-size: 1.1em; }
        .contact-info a { color: #00bcd4; }
        
        footer { background-color: #1f1f1f; color: #cccccc; text-align: center; padding: 20px 0; }

        @media (max-width: 768px) {
            nav a { padding: 10px 15px; font-size: 0.9em; }
...
<body>
    <header>
        <img src="logo.jpg" alt="Logo SkyWatcher">
        <h1>SkyWatcher</h1>
    </header>
